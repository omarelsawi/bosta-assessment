import { getBooks, addBook, updateBook, deleteBook, searchBook } from "../controllers/booksController.js";
    ...
    switch (req.method) {
      ...
      case "POST":
        ...
        try{
          ...
          const queryResponse = await addBook(body.title, body.author, body.isbn, body.quantity, body.shelf_location);
          res.statusCode = 200;
          res.end(JSON.stringify(queryResponse));
        } catch (err) {
          res.statusCode = 400;
